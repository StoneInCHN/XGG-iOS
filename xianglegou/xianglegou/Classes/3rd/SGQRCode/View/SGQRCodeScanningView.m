...
#pragma mark - - - 扫描外部View的创建
    ...
    UIImageView *infoBgImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(scanContent_layer.frame) + 30, 430/2, 82/2)];
    infoBgImage.image = [UIImage imageNamed:@"SGQRCode.bundle/QRCode_scan_bg"];
    [self addSubview:infoBgImage];
    ...
    promptLabel.text = @"扫描商家的二维码即可买单";
    [self addSubview:promptLabel];
    
    infoBgImage.center = promptLabel.center;
