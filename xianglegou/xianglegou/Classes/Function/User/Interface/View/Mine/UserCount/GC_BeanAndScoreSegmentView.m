...
#import "GC_BeanAndScoreSegmentView.h"

@interface GC_BeanAndScoreSegmentView ()<UIScrollViewDelegate>
...
@implementation GC_BeanAndScoreSegmentView
...
-(void)initDefaultWithHeight:(CGFloat)height
{
    ...
    self.frame = CGRectMake(0, 0, 220, height);
