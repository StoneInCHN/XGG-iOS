...
///代理
@protocol GC_BeanAndScoreSegmentDelegate
...
@interface GC_BeanAndScoreSegmentView : UIView

///代理
@property(nonatomic, assign) id<GC_BeanAndScoreSegmentDelegate> delegate;
